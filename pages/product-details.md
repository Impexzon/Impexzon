    ...
    <div class="product-details-container">
        ...
        <div class="pd-info">
            ...
            <div class="pd-specs">
                ...
                <ul>
                    {% if page.specifications.net_weight %}<li><strong>Net Weight:</strong> {{ page.specifications.net_weight }}</li>{% endif %}
                    {% if page.specifications.shelf_life %}<li><strong>Shelf Life:</strong> {{ page.specifications.shelf_life }}</li>{% endif %}
                    {% if page.specifications.allergen_info %}<li><strong>Allergen Info:</strong> {{ page.specifications.allergen_info }}</li>{% endif %}
                    {% if page.specifications.ingredients %}<li><strong>Ingredients:</strong> {{ page.specifications.ingredients }}</li>{% endif %}
                    {% if page.specifications.nutritional_info %}<li><strong>Nutritional Info:</strong> {{ page.specifications.nutritional_info }}</li>{% endif %}
                </ul>
            </div>
